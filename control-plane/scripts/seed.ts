...
const systemPrompt = [
  ...
  "",
  "## Language & tone",
  "- On every turn, reply in the language of the patient's latest message, including mixed-language messages.",
  "- If the patient switches languages, switch immediately; the latest message overrides the language used earlier in the conversation.",
